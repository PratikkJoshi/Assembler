...
def displayST():
    print("""
**********************************************SYMBOL TABLE:***********************************************************************\n
Symbol no\tSymbolName\tCount\ttotalsize\tDEF/UNDEF\t\tU/UN\t\tLineno\t\tSection\t\t\tAddress""")
    for i in Symbol_Table:
...
def displayIC():
  print("""\n\n\n*****************************INTERMEDIATE CODE:*****************************************\n
Lineno\t\topcode\t\toperand1\t\t\toperand2 """)
  
  for i in Inter_Code:
    print("%s\t\t%s\t\t%s\t\t%s" %(i.lno, i.instop, i.oper1, i.oper2))
